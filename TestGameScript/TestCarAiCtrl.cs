...
public class TestCarAiCtrl : MonoBehaviour {
	...
	private TestCarCtrl m_CarController;    // Reference to actual car controller we are controlling
	...
	private void Awake()
	{
		...
		m_CarController = GetComponent<TestCarCtrl>();
	...
	private void OnCollisionStay(Collision col)
	{
		...
		{
			var otherAI = col.rigidbody.GetComponent<TestCarAiCtrl>();
			if (otherAI != null)
			{
