...
//	private bool m_StopWhenTargetReached;                                    // should we stop driving when we reach the target?
	...
	private XKCarMoveCtrl m_CarController;    // Reference to actual car controller we are controlling
	...
	private void OnCollisionStay(Collision col)
	{
		...
		{
			var otherAI = col.rigidbody.GetComponent<XKAiCarMoveCtrl>();
			if (otherAI != null)
			{
	...
	public void SetAiCarTopMoveSpeed(float mvSpeed)
	{
		if (CarMoveCom == null) {
			return;
		}
