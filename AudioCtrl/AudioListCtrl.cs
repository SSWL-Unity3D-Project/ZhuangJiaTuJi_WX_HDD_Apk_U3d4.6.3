...
public class AudioListCtrl : MonoBehaviour {
	...
	public AudioSource ASStage1;					//stage声音1.
	public AudioSource ASStage2;					//stage声音2.
	/**
	 * Boss来袭警告音效.
	 */
	public AudioSource ASBossLaiXi;
	/**
	 * Boss战的胜利音效.
	 */
	public AudioSource ASBossShengLi;
	/**
	 * 全部通关文字音效.
	 */
	public AudioSource ASQuanBuTongGuan;
	/**
	 * 玩家掉落悬崖的音效.
	 */
	public AudioSource ASXuanYaDiaoLuo;
	...
	void ResetGameAudioSource()
	{
		...
		CloseAudioSourceOnAwake(ASBossShengLi);
		CloseAudioSourceOnAwake(ASXuanYaDiaoLuo);
		CloseAudioSourceOnAwake(ASQuanBuTongGuan);
		CloseAudioSourceOnAwake(ASGameOver);
		CloseAudioSourceOnAwake(ASStage1);
		CloseAudioSourceOnAwake(ASStage2);
		CloseAudioSourceOnAwake(ASBossLaiXi);
